(function() {
	...
	var createFace=function(faceName){
		return "<i class='fa fa-"+faceName+ "-o aria-hidden='true'</i>";
	}
	...
	var MEH = createFace("meh");
	var SMILE =createFace("smile");
	var FROWN = createFace("frown");
	var score = 0;
	...
	function disable(elements) {
		//It is better to save elements.length into a variable
		//This way you don;t have to recompute elements.length each time the for loop is executed
